...
# load dataset
data = CSV.File("paper/transplantation.txt")
...
CompetingRisks.mhdev_dishes[] = 0.25
CompetingRisks.mhdev_eta[] = 0.25
CompetingRisks.mhdev_coefficients[] = 0.5
...
# Diagnostics
##########
summary_coefficients(dgn)

# number of dishes
plot(summary_dishes(dgn)[2], title = "", size = (480,360), xlim = (0.0, 23.0), xlabel = "k")

# base measure mass
plot(summary_theta(dgn)[2], title = "", size = (480,360), xlim = (0.0, 11.5), xlabel = "θ")

# kernel shape parameter
plot(summary_eta(dgn)[2], title = "", size = (480,360), xlim = (-0.1,1.9), xlabel = "log(κ)")

# regression coefficient
plot(summary_coefficients(dgn)[2], title = "", size = (480,360), xlim = (-0.6, 0.4), xlabel = "η")
...
proportion_plot(times, proportion_post[:,2,:]; lower = proportion_lower[:,2,:], upper = proportion_upper[:,2,:])
plot!(title = "", size = (480,360), xlim = (0.0,8.5), ylim = (0.0,1.0))
