...
"""
# Dykstra & Laud kernel
kernel(x::Float64, t::Float64, _::Float64) = Float64(x <= t)
kernel(x::Float64, t::Float64, cp::Float64, _::Float64) = (cp) * Float64(x <= t)

# # rectangular kernel
# kernel(x::Float64, t::Float64, eta::Float64) = Float64(x <= t <= x + eta)
# kernel(x::Float64, t::Float64, cp::Float64, eta::Float64) = (cp) * Float64(x <= t <= x + eta)

# # Ornstein–Uhlenbeck kernel
# kernel(x::Float64, t::Float64, eta::Float64) = Float64(x <= t) * sqrt(2.0*eta) * exp( - eta * (t-x) )
# kernel(x::Float64, t::Float64, cp::Float64, eta::Float64) = (cp) * Float64(x <= t) * sqrt(2.0*eta) * exp( - eta * (t-x) )

# # power law kernel
# kernel(x::Float64, t::Float64, eta::Float64) = Float64(x <= t) * eta / ( 1.0 + eta * (t-x) )
# kernel(x::Float64, t::Float64, cp::Float64, eta::Float64) = (cp) * Float64(x <= t) * eta / ( 1.0 + eta * (t-x) )
...
"""
# Dykstra & Laud kernel
KernelInt(x::Float64, t::Float64, _::Float64) = Float64(x <= t) * (t-x)
KernelInt(x::Float64, t::Float64, cp::Float64, _::Float64) = (cp) * Float64(x <= t) * (t-x)

# # rectangular kernel
# KernelInt(x::Float64, t::Float64, eta::Float64) = Float64(x <= t <= x + eta) * (t-x)
# KernelInt(x::Float64, t::Float64, cp::Float64, eta::Float64) = (cp) * Float64(x <= t <= x + eta) * (t-x)

# # Ornstein–Uhlenbeck kernel
# KernelInt(x::Float64, t::Float64, eta::Float64) = Float64(x <= t) * sqrt(2.0/eta) * (1.0 - exp( - eta * (t-x) ))
# KernelInt(x::Float64, t::Float64, cp::Float64, eta::Float64) = (cp) * Float64(x <= t) * sqrt(2.0/eta) * (1.0 - exp( - eta * (t-x) ))

# # power law kernel
# KernelInt(x::Float64, t::Float64, eta::Float64) = (x <= t) ? log( 1.0 + eta * (t-x) ) : 0.0
# KernelInt(x::Float64, t::Float64, cp::Float64, eta::Float64) = (x <= t) ? (cp) * log( 1.0 + eta * (t-x) ) : 0.0
